...
const MPPendiente = () => {
  ...
  const mensajeWhatsapp = encodeURIComponent(
    "Hola, mi pago está pendiente. ¿Podrían informarme el estado, por favor?"
  );
  ...
  <h1 className="estado-titulo" style={{ color: "#ca8a04" }}>Pago pendiente</h1>
  <p className="estado-texto">
    Tu pago está pendiente. Por favor, comunícate con nosotros para más información.
  </p>
  <div className="estado-botones">
    <button onClick={() => navigate("/misCompras")} className="estado-btn yellow">
      Ir a mis compras
    </button>
